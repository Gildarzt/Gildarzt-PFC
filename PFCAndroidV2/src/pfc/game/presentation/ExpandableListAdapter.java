...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<AuxGoal>> _listDataChild;
 
    public ExpandableListAdapter(Context context, List<String> listDataHeader,
            HashMap<String, List<AuxGoal>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
    	...
    	AuxGoal child=(AuxGoal)getChild(groupPosition, childPosition);
    	...
    	if(child.isState())
    		txtListChild.setText(child.getName()+" ¡CONSEGUIDO!");
    	else
    		txtListChild.setText(child.getName());
    	
    	txtListChildDescp.setText(child.getDescp());
